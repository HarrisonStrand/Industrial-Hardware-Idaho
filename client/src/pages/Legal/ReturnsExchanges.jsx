...
export default function ReturnsExchanges() {
	...
	return (
		<>
						...
						<div className='row m-0'>
							<div className='legal-copy text-main'>
								<p className='mb-3'>
									...
									explains how returns and exchanges work for online orders from{" "}
								...
								<p className='mb-3'>
									...
									<span className='fw-semibold'>30 days</span> of delivery (or
									pickup), provided the item is unused, uninstalled, and in
								...
								<p className='mb-3'>
									A <span className='fw-semibold'>5% restocking fee</span> may
									apply to eligible returns. Shipping charges are not refundable
								...
								<ul className='legal-list'>
									<li>
										Items must be unused, uninstalled, and in resalable
										condition.
									</li>
									<li>
										Original packaging, labels, and included parts must be
										intact.
									</li>
								...
								<p className='mb-2'>
									Contact us to request return instructions. Please include your
									order number and a brief description of the return.
								</p>
								<ul className='legal-list'>
									{EMAIL && (
										<li>
								...
								<ul className='legal-list'>
									<li>
										<span className='fw-semibold'>
											In-store return (local pickup items):
										</span>{" "}
										Bring the item to our location during regular hours.
									</li>
									<li>
										<span className='fw-semibold'>Ship-back return:</span>{" "}
										Return shipping is typically the customer’s responsibility
								...
								<p className='mb-3'>
									After receiving and inspecting your return, refunds are
									typically processed within{" "}
									<span className='fw-semibold'>5–10 business days</span>.
									Refunds are issued to the original payment method when
									possible.
								</p>
								...
								<p className='mb-0'>
									If your order arrives damaged or incorrect, contact us
									promptly. Keep all packaging and take photos if possible so we
									can help quickly.
								</p>
			...
			<ContactBanner />
			<FAQAccordion
				categories={["returns", "ordering"]}
				title='Returns FAQs'
				subtitle='Quick answers about return eligibility, approval, and support.'
			/>
		</>
	);
}
