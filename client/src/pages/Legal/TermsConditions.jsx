              ...
              <div className='legal-copy text-main'>
                <p className='mb-3'>
                  ...
                  {WEBSITE ? (
                    <>
                      {" "}
                      <Link to={'/'} className="text-decoration-none text-secondary"><span className='fw-semibold'>{WEBSITEBASIC}</span></Link>
                    </>
                  ) : null}
                ...
                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Orders & acceptance</h5>
                ...
                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Pricing & availability</h5>
                <ul className='legal-list'>
                ...
                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Payments</h5>
                <p className='mb-3'>
                ...
                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Tax & tax-exempt orders</h5>
                <p className='mb-3'>
                ...
                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Shipping & delivery</h5>
                <ul className='legal-list'>
                ...
                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Returns</h5>
                <p className='mb-3'>
                ...
                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Account responsibility</h5>
                <ul className='legal-list'>
                  <li>You are responsible for maintaining account confidentiality.</li>
                  <li>You agree to notify us of any unauthorized account use.</li>
                </ul>

                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Prohibited use</h5>
                <ul className='legal-list'>
                ...
                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Disclaimers</h5>
                <p className='mb-3'>
                ...
                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Limitation of liability</h5>
                <p className='mb-3'>
                ...
                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Changes</h5>
                <p className='mb-3'>
                  We may update these Terms from time to time. Continued use of the site after
                  changes means you accept the updated terms.
                </p>

                <h5 className='legal-title text-uppercase mt-4 text-center text-md-start'>Contact</h5>
                <p className='mb-0'>
